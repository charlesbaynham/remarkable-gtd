...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(description="Scan a marked GTD sheet and produce decisions JSON.")
    ...
    p.add_argument("--page", default=None, help="Page key from manifest (auto if only one page).")
